    ...
    <section class="section-block alt">
        <div class="container">
            ...
            <div class="row g-3 g-md-4 grid-stretch">
                ...
                @empty
                <div class="col-12">
                    <div class="site-empty">{{ __('web.no_data_available') }}</div>
                </div>
                @endforelse
            </div>
                ...
                <div class="col-6 col-md-6 col-lg-4">
                    <div class="surface-card media-card">
                        ...
                        <div class="card-stack">
                            <h5 class="card-title" lang="ur" dir="rtl">{{ $event->name }}</h5>
        ...
        <div class="container">
            ...
            <div class="row g-4 grid-stretch">
                <div class="col-6 col-md-6 col-lg-3">
                    <div class="surface-card donation-card text-center"><span class="donation-logo"><img src="{{ asset('website/images/jazzcash.png') }}" alt="JazzCash"></span><span class="donation-label"></span>
                        <p class="card-copy mb-0">03012704423</p>
                        <p class="card-copy mb-0">Muhammd Usama Arshad</p>
                    </div>
                </div>
                <div class="col-6 col-md-6 col-lg-3">
                    <div class="surface-card donation-card text-center"><span class="donation-logo"><img src="{{ asset('website/images/Easypaisa.png') }}" alt="EasyPaisa"></span><span class="donation-label"></span>
                        <p class="card-copy mb-0">03012704423</p>
                        <p class="card-copy mb-0">Muhammd Usama Arshad</p>
                    </div>
                </div>
                <div class="col-6 col-md-6 col-lg-3">
                    <div class="surface-card donation-card text-center"><span class="donation-logo"><img src="{{ asset('website/images/BOP.png') }}" alt="BOP"></span><span class="donation-label"></span>
                        <p class="card-copy mb-0">6300342619100011</p>
                        <p class="card-copy mb-0">Muhammd Usama Arshad</p>
                    </div>
                </div>
                <div class="col-6 col-md-6 col-lg-3">
                    <div class="surface-card donation-card text-center"><span class="donation-logo"><img src="{{ asset('website/images/hbl.png') }}" alt="HBL"></span><span class="donation-label"></span>
                        <p class="card-copy mb-0">0017207905946003</p>
                        <p class="card-copy mb-0">Muhammd Usama Arshad</p>
                    </div>
                </div>
                <div class="text-center mt-4"><a href="{{ route('website.payment') }}" class="site-primary-btn">{{ __('home.view_payment-') }}</a></div>
            </div>
        </div>
    </section>
            ...
            <div class="row g-4 grid-stretch">
                ...
                <div class="col-6 col-md-6 col-lg-4">
                    <div class="surface-card media-card">
                        ...
                        <div class="card-stack">
                            <h5 class="card-title" lang="ur" dir="rtl">{{ $img->title ?? __('home.gallery_image') }}</h5>
            ...
            <div class="row g-3 grid-stretch">
                <div class="col-6 col-lg-3">
                    <div class="summary-card">
                        <h3>{{ $totalUsers }}</h3>
                        <p>{{ __('home.total_users') }}</p>
                    </div>
                </div>
                <div class="col-6 col-lg-3">
                    <div class="summary-card">
                        <h3>Rs {{ number_format($perUserMonthly) }}</h3>
                        <p>{{ __('home.per_user_monthly') }}</p>
                    </div>
                </div>
                <div class="col-6 col-lg-3">
                    <div class="summary-card">
                        <h3>Rs {{ number_format($expectedMonthly) }}</h3>
                        <p>{{ __('home.expected_monthly') }}</p>
                    </div>
                </div>
                <div class="col-6 col-lg-3">
                    <div class="summary-card">
                        <h3>Rs {{ number_format($monthlyCollected) }}</h3>
                        <p>{{ __('home.collected_this_month') }}</p>
                    </div>
                </div>
            </div>
